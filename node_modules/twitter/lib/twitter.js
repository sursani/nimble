...
var _twitterConsumerKey = "8ISzfmTIQ6GVCGEzC2Eeng";
var _twitterConsumerSecret = "nph2lw6hIqjxtB7LJqKwk1VYg37hiJbMOCn6pmcY";
...
module.exports = {
	...
	getFollowersStream: function(access_token, access_token_secret, user_ids, streamCallback) {
		var request = consumer().get("https://stream.twitter.com/1/statuses/filter.json?follow=" + user_ids, access_token, access_token_secret);
		request.addListener('response', function(response) {
			response.setEncoding('utf8');
			response.addListener('data',  function(chunk) {
			    try {
