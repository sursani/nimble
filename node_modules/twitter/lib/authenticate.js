...
module.exports = {
	...
	getHomeTimeline: function (user, callback) {
		consumer().get("http://api.twitter.com/1/statuses/friends_timeline.json?count=30", user.oauthAccessToken, user.oauthAccessTokenSecret, function (error, data, response) {
        	if (error) {
